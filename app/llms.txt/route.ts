...
export async function GET() {
  ...
  const body = [
    ...
    "",
    "## Clean markdown mirrors",
    "Every article is also available as raw markdown by appending .md to its URL.",
    "These mirrors strip the metadata export block and serve content directly,",
    "with no ads, hydration, or navigation — ideal for inference-time retrieval.",
    `For example: ${siteUrl}/zh/commands/git-rebase.md`,
    `or:          ${siteUrl}/en/internals/object-database.md`,
    "",
    "## Full maps",
