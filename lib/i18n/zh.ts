...
export const zhDictionary: Dictionary = {
      ...
      baseSidebar("zh", [
        ...
        },
        {
          ...
          items: [
            ...
            buildPlatformsNavItem("zh", activePath),
            buildDevopsNavItem("zh", activePath),
  ...
  platformsIndex: {
    eyebrow: "Platforms",
    title: "平台协作专题",
    description: "把 GitHub 与 GitLab 常见能力拆成本地教程，从 GitHub Flow / GitLab Flow、PR / MR 与 review，到 fork 贡献、Issues / Boards、权限与 CI/CD 基础。",
  },
  learningPathIndex: {
    eyebrow: "Quick Start",
    title: "Git 快速上手专题",
  ...
  devopsIndex: {
    eyebrow: "DevOps",
    title: "DevOps 工具链",
    description: "把 Git 与 CI/CD 管线、IDE / 终端工具的集成拆成本地教程，包括 GitHub Actions、GitLab CI、Jenkins、VS Code、JetBrains 与终端 Git UI。",
  },
  securityIndex: {
    eyebrow: "Security",
    title: "安全",
  ...
  docsIndex: {
    ...
    sections: [
      ...
      },
      {
        ...
        eyebrow: "DevOps",
        title: "DevOps 工具链",
        description: "Git 与 CI/CD、IDE 工具链的集成。",
      },
      {
        id: "security",
        eyebrow: "Security",
