...
- Understand the core purpose of Commit Hygiene and Messages
- Master the basic usage and common options of Commit Hygiene and Messages
...
- Understand key concepts: Why this topic comes first
...
1. Practice the commit-hygiene command in a test repository and observe state changes before and after
