...
- Understand the core purpose of Security best practices with Git
- Master the basic usage and common options of Security best practices with Git
- Handling sensitive info leaks, key management, .env security, git-secrets, GPG-signed commits, and SSH key management.
- Understand key concepts: Handling accidentally committed sensitive info
...
1. Practice the security-with-git command in a test repository and observe state changes before and after
