...
- Understand the core purpose of Advanced commit message conventions
- Master the basic usage and common options of Advanced commit message conventions
...
- Understand key concepts: Basic commit message structure
...
1. Practice the commit-message-advanced command in a test repository and observe state changes before and after
