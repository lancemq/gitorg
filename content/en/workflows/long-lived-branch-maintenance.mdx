...
- Understand the core purpose of Maintaining Long-lived Branches
- Master the basic usage and common options of Maintaining Long-lived Branches
- Show how long-lived branches can stay aligned with main and avoid painful late merges.
- Understand key concepts: Why long-lived branches get expensive
...
<RebaseFigure
  title="Long-lived Branch Sync with Main"
  caption="Long-lived branches need regular rebase or merge with main. Rebase keeps history linear but rewrites commit IDs, merge preserves full history but creates merge commits."
  beforeLabel="Long-lived branch behind main"
  afterLabel="After syncing main"
  modeLabel="git rebase origin/main"
/>
...
3. [`Squash vs rebase merge`](/en/workflows/squash-vs-rebase-merge)

## Try it yourself

1. Practice the long-lived-branch-maintenance command in a test repository and observe state changes before and after
...
- [Merge Queue Workflow](/en/workflows/merge-queue-workflow)
