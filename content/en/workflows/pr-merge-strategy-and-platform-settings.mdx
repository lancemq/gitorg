  ...
  citations: [
    {
      ...
      url: "https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/configuring-pull-request-merges/about-merge-methods-on-github?apiVersion=2022-11-28",
      kind: "discussion",
    },
    {
      title: "About pull request merges",
      url: "https://docs.github.com/articles/about-pull-request-merges",
      kind: "discussion",
    },
  ],
};
...
- Understand the core purpose of PR Merge Strategy and Platform Settings
- Master the basic usage and common options of PR Merge Strategy and Platform Settings
...
- Understand key concepts: Why these two decisions belong together
...
1. [`Squash vs rebase merge`](/en/workflows/squash-vs-rebase-merge)
2. [`Merge queue workflow`](/en/workflows/merge-queue-workflow)
3. [`Sync before review`](/en/workflows/sync-before-review)

## Try it yourself

1. Practice the pr-merge-strategy-and-platform-settings command in a test repository and observe state changes before and after
...
- [Post-release Multi-branch Backporting](/en/workflows/post-release-multi-branch-backporting)
- [Pre-commit Hook Workflow](/en/workflows/pre-commit-hook-workflow)
