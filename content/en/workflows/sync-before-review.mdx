...
2. [`Squash vs rebase merge`](/en/workflows/squash-vs-rebase-merge)
3. [`Fetch vs pull`](/en/workflows/fetch-vs-pull)

## Try it yourself

1. Practice the sync-before-review command in a test repository and observe state changes before and after
