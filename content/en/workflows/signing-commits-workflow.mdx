...
- Understand the core purpose of Signing Commits Workflow
- Master the basic usage and common options of Signing Commits Workflow
- Use GPG or SSH to sign commits, establishing verifiable commit identity and a trusted collaboration chain.
- Understand key concepts: Why signed commits are needed
...
1. Practice the signing-commits-workflow command in a test repository and observe state changes before and after
