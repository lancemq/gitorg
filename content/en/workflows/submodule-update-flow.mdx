...
- Understand the core purpose of Submodule Update Flow
- Master the basic usage and common options of Submodule Update Flow
- Outline a safe routine for updating submodules, locking revisions, and syncing the parent repository.
- Understand key concepts: Why this workflow is easy to misread
...
1. Practice the submodule-update-flow command in a test repository and observe state changes before and after
...
- [Trunk-Based Development Workflow](/en/workflows/trunk-based-development-workflow)
