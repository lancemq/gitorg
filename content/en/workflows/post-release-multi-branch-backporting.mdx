...
- Understand the core purpose of Post-release Multi-branch Backporting
- Master the basic usage and common options of Post-release Multi-branch Backporting
- Control order, validation, and branch boundaries when one fix must be backported into multiple released maintenance lines.
- Understand key concepts: What this workflow really solves
...
1. [`Backport with cherry-pick`](/en/workflows/backport-with-cherry-pick)
...
1. Practice the post-release-multi-branch-backporting command in a test repository and observe state changes before and after
