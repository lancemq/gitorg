...
- Understand the core purpose of Fork and Upstream Sync
- Master the basic usage and common options of Fork and Upstream Sync
...
1. Practice the fork-upstream-sync command in a test repository and observe state changes before and after
