...
1. [`git-bisect`](/en/commands/git-bisect)
2. [`Hotfix and urgent fixes`](/en/workflows/hotfix-and-urgent-fixes)
3. [`Recover after reset`](/en/recovery/recover-after-reset)

## Try it yourself

1. Practice the bisect-regression-triage-workflow command in a test repository and observe state changes before and after
