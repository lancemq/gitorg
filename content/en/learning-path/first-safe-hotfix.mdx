...
2. [`revert-first stabilization workflow`](/en/workflows/revert-first-stabilization-workflow)
3. [`recover after accidental merge`](/en/recovery/recover-after-accidental-merge)
...
- [First Feature Branch](/en/learning-path/first-feature-branch)
