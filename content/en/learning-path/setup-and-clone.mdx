...
- Understand the core purpose of Setup and Clone
- Master the basic usage and common options of Setup and Clone
...
- Understand key concepts: What this step should achieve
...
2. [`git status`](/en/commands/git-status) is clean
...
1. Practice the setup-and-clone command in a test repository and observe state changes before and after
...
- [Remote Sync](/en/learning-path/sync-with-remote)
