...
- Understand the core purpose of Remote Sync
- Master the basic usage and common options of Remote Sync
...
- Understand key concepts: Why beginners often get stuck here
...
1. Practice the sync-with-remote command in a test repository and observe state changes before and after
...
- [Safe Ways to Undo Local Changes](/en/learning-path/undo-local-basics)
- [Viewing History and Changes](/en/learning-path/view-history-and-changes)
