...
- Understand the core purpose of GitHub Flow Basics
- Master the basic usage and common options of GitHub Flow Basics
...
- Understand key concepts: What it actually is
...
1. Practice the github-flow-basics command in a test repository and observe state changes before and after
