export const metadata = {
  ...
  citations: [
    ...
    {
      title: "Milestones",
      url: "https://docs.gitlab.com/user/project/milestones/",
      kind: "blog",
    },
  ],
};
...
- Understand the core purpose of GitLab Issues, Boards, and Milestones
- Master the basic usage and common options of GitLab Issues, Boards, and Milestones
...
- Understand key concepts: Why merge requests are not enough
...
- [GitLab merge trains and merged result pipelines](/en/platforms/gitlab-merge-trains-and-merge-result-pipelines)
