export const metadata = {
  ...
  citations: [
    {
      title: "docs.gitlab.com — Group",
      url: "https://docs.gitlab.com/user/group/",
      kind: "blog",
    },
    {
      title: "docs.gitlab.com — Project",
      url: "https://docs.gitlab.com/user/project/",
      kind: "blog",
    },
    {
      title: "User permissions",
      url: "https://docs.gitlab.com/auth/user_permissions/",
      kind: "blog",
    },
  ],
};
...
- Understand the core purpose of GitLab Groups, Projects, and Permissions
- Master the basic usage and common options of GitLab Groups, Projects, and Permissions
...
- Understand key concepts: Start by separating group, subgroup, and project
...
1. [`GitLab Flow and Merge Requests`](/en/platforms/gitlab-flow-and-merge-requests)
2. `GitLab CI/CD and Runners`
3. [`Shared History Boundaries`](/en/best-practices/shared-history-boundaries)

## Try it yourself

1. Practice the gitlab-groups-projects-and-permissions command in a test repository and observe state changes before and after
