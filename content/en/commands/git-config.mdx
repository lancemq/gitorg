...
- Understand the core purpose of git-config Tutorial
- Master the basic usage and common options of git-config Tutorial
...
1. Practice the git-config command in a test repository and observe state changes before and after
