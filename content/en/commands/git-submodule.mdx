...
- Understand the core purpose of git-submodule Tutorial
- Master the basic usage and common options of git-submodule Tutorial
...
- Understand key concepts: Core commands
...
1. [`submodule update flow`](/en/workflows/submodule-update-flow)
2. `cross repository integration workflow`
3. [`git-bundle`](/en/commands/git-bundle)
...
1. Practice the git-submodule command in a test repository and observe state changes before and after
