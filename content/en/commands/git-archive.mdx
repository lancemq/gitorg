...
- Understand the core purpose of git-archive Tutorial
- Master the basic usage and common options of git-archive Tutorial
...
1. Practice the git-archive command in a test repository and observe state changes before and after
