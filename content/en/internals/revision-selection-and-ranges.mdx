...
- Understand the core purpose of Revision Selection and Commit Ranges
- Master the basic usage and common options of Revision Selection and Commit Ranges
...
- Understand key concepts: Why revision syntax matters
...
1. Practice the revision-selection-and-ranges command in a test repository and observe state changes before and after
