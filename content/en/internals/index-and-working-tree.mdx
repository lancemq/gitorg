...
- Understand the core purpose of Working Tree, Index, and Object Store
- Master the basic usage and common options of Working Tree, Index, and Object Store
...
<ThreeLayersFigure
  title="Working tree, index, and object store"
  caption="Most Git confusion is really layer confusion. Once you know which command touches which layer, the behavior becomes much easier to predict."
  worktreeLabel="Working tree"
  indexLabel="Index"
  objectsLabel="Object store"
  addLabel="git add"
  commitLabel="git commit"
  restoreLabel="git restore / reset"
/>
...
1. Practice the index-and-working-tree command in a test repository and observe state changes before and after
