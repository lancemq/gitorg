...
- Understand the core purpose of Merge Bases and Ancestry
- Master the basic usage and common options of Merge Bases and Ancestry
- Explain how Git uses common ancestors to reason about branch differences, merge inputs, and reachability.
- Understand key concepts: Start with the core idea
...
<MergeFigure
  title="Merge Base and Branch Divergence"
  caption="When two branches diverge from a common base, Git finds the most recent common ancestor (merge base) to perform a three-way comparison, identifying each branch's independent changes."
  beforeLabel="Before divergence (common ancestor)"
  afterLabel="After divergence (independent histories)"
  modeLabel="find merge base"
/>
...
1. Practice the merge-base-and-ancestry command in a test repository and observe state changes before and after
...
- [Git Object Database](/en/internals/object-database)
