...
1. [`tree objects and snapshots`](/en/internals/tree-objects-and-snapshots)
...
- [Remote-Tracking References](/en/internals/remote-tracking-refs)
- [Repository Layout, .git, and GIT_DIR](/en/internals/repository-layout-and-gitdir)
