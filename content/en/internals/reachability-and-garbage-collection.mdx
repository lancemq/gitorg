...
- Understand the core purpose of Reachability and Garbage Collection
- Master the basic usage and common options of Reachability and Garbage Collection
...
- Understand key concepts: What reachability means
...
<ReflogFigure
  ...
  caption="As long as an object is traceable from branches, tags, or reflog entries, it is reachable. Objects that lose all references become unreachable and are eventually cleaned up by gc."
  historyLabel="Historical reference chain"
  rescueLabel="Recovery entry point"
...
1. Practice the reachability-and-garbage-collection command in a test repository and observe state changes before and after
