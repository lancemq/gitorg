...
- Understand the core purpose of Refspecs and Ref Updates
- Master the basic usage and common options of Refspecs and Ref Updates
- Explain how refspecs determine which refs are mapped and updated during fetch and push.
- Understand key concepts: Start with the real problem
...
<RefsHeadFigure
  title="How Refspecs Map Remote to Local Refs"
  caption="Fetch refspecs map remote refs/heads/* to local refs/remotes/origin/*. Push refspecs map local refs/heads/* to remote refs/heads/*."
  headLabel="Fetch mapping"
  branchLabel="refs/heads/main → refs/remotes/origin/main"
  tagLabel="refs/tags/* → refs/tags/*"
  remoteLabel="Remote refs"
  detachedLabel="Push mapping"
/>
...
1. Practice the refspec-and-ref-updates command in a test repository and observe state changes before and after
...
- [Git References and HEAD](/en/internals/refs-and-head)
