...
<ResetFigure
  title="Reset Three-Layer Impact and Recovery"
  caption="git reset affects HEAD, index, and working tree simultaneously. soft moves HEAD only, mixed also resets index, hard also overwrites working tree files. Reflog can find the pre-reset position."
  layersLabel="Impact layer"
  softLabel="--soft"
  mixedLabel="--mixed"
  hardLabel="--hard"
/>
...
1. Practice the recover-after-reset command in a test repository and observe state changes before and after
