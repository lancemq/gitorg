...
- 理解 多人协作时的同步节奏 的核心作用和适用场景
- 掌握 多人协作时的同步节奏 的基本用法和常用参数
- 围绕多人并行开发，建立一套先 fetch、再观察、再整合的同步节奏，减少 pull 惊喜和共享历史误操作。
- 理解 为什么不建议把一切都交给 pull 相关的概念
- 掌握 一个团队可执行的同步顺序 相关的操作
...
- [开源贡献 / fork + PR 完整提交流程](/zh/workflows/open-source-fork-pr-contribution)
