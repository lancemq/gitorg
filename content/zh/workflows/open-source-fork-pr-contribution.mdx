...
- 理解 开源贡献 / fork + PR 完整提交流程 的核心作用和适用场景
- 掌握 开源贡献 / fork + PR 完整提交流程 的基本用法和常用参数
...
1. [`Fork upstream sync`](/zh/workflows/fork-upstream-sync)
2. [`Sync before review`](/zh/workflows/sync-before-review)
3. [`Feature branch collaboration`](/zh/workflows/feature-branch-collaboration)
...
- [多人协作时的同步节奏](/zh/workflows/multi-person-sync-routine)
- [用 worktree 并行处理多个任务](/zh/workflows/parallel-work-with-worktree)
