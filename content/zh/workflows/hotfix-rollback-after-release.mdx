...
- 理解 发布后热修失败，如何回滚与稳定主线 的核心作用和适用场景
- 掌握 发布后热修失败，如何回滚与稳定主线 的基本用法和常用参数
- 当发布后热修本身引入问题时，优先判断回滚粒度、共享影响和后续补丁路径，而不是立刻继续叠加修复。
- 理解 第一步不是继续提交，而是判断事故边界 相关的概念
- 掌握 为什么很多情况下优先考虑 revert 相关的操作
...
- [大文件处理工作流](/zh/workflows/large-file-handling-workflow)
