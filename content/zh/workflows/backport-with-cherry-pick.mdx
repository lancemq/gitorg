export const metadata = {
  title: "使用 Cherry-pick 回移修复",
  slug: "backport-with-cherry-pick",
  locale: "zh",
  section: "workflows",
  summary: "把主线上的精确修复回移到维护分支，而不是把整条功能分支或无关历史一起合进去。",
  sourceUrls: [
...
- 理解 使用 Cherry-pick 回移修复 的核心作用和适用场景
- 掌握 使用 Cherry-pick 回移修复 的基本用法和常用参数
...
<CherryPickFigure
  title="Cherry-Pick 回移修复"
  caption="从 main 分支挑选特定的修复提交，应用到旧版本维护分支。每次 cherry-pick 生成内容相同但 ID 不同的新提交。"
  sourceLabel="main (主线)"
  targetLabel="release/2.x (维护线)"
