...
- 理解 PR 合并策略与平台配置 的核心作用和适用场景
- 掌握 PR 合并策略与平台配置 的基本用法和常用参数
- 把 squash merge、rebase merge、merge commit 和平台配置放到同一个决策框架里，帮助团队统一 PR 落地方式。
- 理解 为什么要把策略和平台配置放在一起看 相关的概念
- 掌握 建议先统一 3 个问题 相关的操作
...
1. [`Squash vs rebase merge`](/zh/workflows/squash-vs-rebase-merge)
2. [`Merge queue workflow`](/zh/workflows/merge-queue-workflow)
...
- [发布后多维护线回移策略](/zh/workflows/post-release-multi-branch-backporting)
- [提交前检查工作流](/zh/workflows/pre-commit-hook-workflow)
- [发布前的 Git 检查清单](/zh/workflows/pre-release-checklist)
