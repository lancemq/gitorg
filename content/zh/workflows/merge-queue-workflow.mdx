...
- 理解 Merge Queue 工作流 的核心作用和适用场景
- 掌握 Merge Queue 工作流 的基本用法和常用参数
- 当团队并发合并很多 PR 时，用 merge queue 降低串行抢占主线、重复排队和基底过期的问题。
- 理解 这个工作流适合什么团队 相关的概念
- 掌握 它真正解决的核心问题 相关的操作
...
1. [`PR merge strategy and platform settings`](/zh/workflows/pr-merge-strategy-and-platform-settings)
...
- [monorepo 场景下的稀疏检出与多工作树协作](/zh/workflows/monorepo-sparse-checkout-workflow)
