...
1. 手动解决
2. [`git add`](/zh/commands/git-add) 暂存结果
3. 完成 rebase 或 merge
...
1. [`long-lived branch conflict governance`](/zh/workflows/long-lived-branch-conflict-governance)
2. [`long-lived branch maintenance`](/zh/workflows/long-lived-branch-maintenance)
