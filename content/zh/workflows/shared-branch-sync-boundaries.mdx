...
- 理解 多人共享分支的同步边界 的核心作用和适用场景
- 掌握 多人共享分支的同步边界 的基本用法和常用参数
- 当多人同时在同一分支协作时，明确什么动作可以做、什么动作不该做，减少同步混乱和历史覆盖。
- 理解 为什么共享分支特别容易踩坑 相关的概念
- 掌握 最核心的一条原则 相关的操作
...
1. [`Fetch vs pull`](/zh/workflows/fetch-vs-pull)
2. [`PR merge strategy and platform settings`](/zh/workflows/pr-merge-strategy-and-platform-settings)
...
- [签名提交工作流](/zh/workflows/signing-commits-workflow)
