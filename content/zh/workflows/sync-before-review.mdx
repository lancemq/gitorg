...
- 理解 评审前同步主线 的核心作用和适用场景
- 掌握 评审前同步主线 的基本用法和常用参数
- 在发起评审前先同步主线并检查差异范围，减少 reviewer 面对过期基底、重复冲突和历史噪声的成本。
- 理解 为什么评审前一定要做这一步 相关的概念
- 掌握 推荐流程 相关的操作
...
2. [`Squash vs rebase merge`](/zh/workflows/squash-vs-rebase-merge)
3. [`Fetch vs pull`](/zh/workflows/fetch-vs-pull)
