...
- 理解 Git 提交图与历史表达 的核心作用和适用场景
- 掌握 Git 提交图与历史表达 的基本用法和常用参数
- 理解为什么 Git 历史本质上是提交图，而不是简单时间线，以及 merge、rebase 如何重新表达这张图。
- 理解 1. 为什么“历史图”比“提交列表”更准确 相关的概念
- 掌握 2. 普通提交如何形成一条线 相关的操作
...
<CommitGraphFigure
  title="提交图如何表达分叉、汇合与重写"
  caption="同样是“把改动整合起来”，merge 会保留汇合点，rebase 会把一段提交重新接到新父链后面。图结构不同，提交 ID 和阅读体验也会跟着不同。"
  linearLabel="线性提交链"
  mergeLabel="保留汇合点"
  rewriteLabel="重写后的线性表达"
  pointerLabel="当前引用"
/>
...
- [Blob 对象与内容寻址教程](/zh/internals/blob-objects-and-content-addressing)
