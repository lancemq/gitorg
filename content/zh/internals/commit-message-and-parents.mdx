...
- 理解 提交对象、父提交与提交说明教程 的核心作用和适用场景
- 掌握 提交对象、父提交与提交说明教程 的基本用法和常用参数
- 说明提交对象如何把 tree、父提交和说明文本连接成历史图。
- 理解 1. 提交对象里至少有什么 相关的概念
- 掌握 2. 为什么父提交很关键 相关的操作
...
<CommitGraphFigure
  title="提交如何通过父提交链接成历史"
  caption="每个 commit 对象包含指向 tree 的引用、一个或多个父提交、作者和提交者信息，以及提交说明。父提交是历史图的关键链接。"
  linearLabel="普通提交（一个父节点）"
  mergeLabel="Merge 提交（两个父节点）"
  rewriteLabel="Rebase 后提交（新 ID 的提交链）"
  pointerLabel="HEAD 指向"
/>
