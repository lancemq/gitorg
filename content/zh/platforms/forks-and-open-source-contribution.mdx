...
<PlatformHierarchyFigure
  title="Fork 贡献流程"
  caption="Fork 是上游仓库的完整副本。你在 fork 中开发，通过 Pull Request 将变更贡献回上游。这是开源贡献的标准模式。"
  topLabel="上游仓库"
  topItems="upstream/main|原始项目|维护者权限"
  middleLabel="你的 Fork"
  middleItems="origin/main|feature 分支|你的提交"
  bottomLabel="Pull Request"
  bottomItems="从 fork 到 upstream|代码评审|合并回上游"
/>
