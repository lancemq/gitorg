...
- 理解 GitLab Groups、Projects 与权限模型 的核心作用和适用场景
- 掌握 GitLab Groups、Projects 与权限模型 的基本用法和常用参数
- 理解 GitLab 里 group、project、role 和权限继承的关系，避免团队协作一开始就把访问边界做乱。
- 理解 先分清 group、subgroup 和 project 相关的概念
- 掌握 为什么权限继承既方便又危险 相关的操作
...
1. [`GitLab Flow 与 Merge Request`](/zh/platforms/gitlab-flow-and-merge-requests)
