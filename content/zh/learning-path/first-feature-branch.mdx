...
- 理解为什么要从主分支切出特性分支再开发
- 用 `git switch -c` 创建并切换到新分支
- 在分支上完成修改→提交的独立工作
- 把本地分支推送到远端并建立上游跟踪关系
- 理解 merge 和 rebase 在快速上手阶段的核心区别
...
你现在做一个小任务——比如给项目加一个登录表单。你是直接在 main 分支上改，还是开一个新分支？如果开分支，怎么开？开完之后怎么把改的东西拿回主线？——如果你不能立刻给出答案，这一页就是帮你建立起"在分支上工作"的最小安全节奏。
