...
1. [`commit message conventions`](/zh/best-practices/commit-message-conventions)
2. [`release checklist discipline`](/zh/best-practices/release-checklist-discipline)
3. [`git-show`](/zh/commands/git-show)
