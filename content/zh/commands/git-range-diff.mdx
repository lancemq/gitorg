...
- 理解 git-range-diff 教程 的核心作用和适用场景
- 掌握 git-range-diff 教程 的基本用法和常用参数
...
2. [`stacked pull requests workflow`](/zh/workflows/stacked-pull-requests-workflow)
3. [`git-rebase`](/zh/commands/git-rebase)
