export const metadata = {
  ...
  citations: [
    ...
    {
      title: "Git Tools Shallow Cloning",
      url: "https://git-scm.com/book/en/v2/Git-Tools-Shallow-Cloning",
      kind: "book",
    },
  ],
};
...
- 理解 Git 浅克隆与浅操作 的核心作用和适用场景
- 掌握 Git 浅克隆与浅操作 的基本用法和常用参数
...
1. [`git sparse-checkout`](/zh/commands/git-sparse-checkout) —— 只检出部分目录
2. [`git filter-repo`](/zh/migration/git-filter-repo) —— 改写仓库历史
3. [`git bundle`](/zh/commands/git-bundle) —— 离线传输仓库
...
- [Git Rerere 深入](/zh/concepts/git-rerere-deep)
