...
1. [`git switch`](/zh/commands/git-switch) 和 `git checkout` 的区别
2. [`git reflog`](/zh/commands/git-reflog) 用于找回 detached HEAD 中丢失的提交
3. [`git bisect`](/zh/commands/git-bisect) 如何利用 detached HEAD 进行二分查找
4. [`git branch`](/zh/commands/git-branch) 如何创建新分支来保留实验性提交
