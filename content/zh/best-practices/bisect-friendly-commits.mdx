...
- 理解 二分友好的提交 的核心作用和适用场景
- 掌握 二分友好的提交 的基本用法和常用参数
- 保持每次提交独立可构建、可测试，让 git bisect 能高效定位引入问题的提交。
- 理解 为什么需要 bisect-friendly 提交 相关的概念
- 掌握 bisect-friendly 的核心原则 相关的操作
...
<CommitGraphFigure
  title="bisect-friendly 的提交历史"
  caption="每次提交只做一件事，并且每个提交都能独立通过测试，这样 git bisect 才能快速定位问题。"
  linearLabel="线性提交"
  mergeLabel="合并点"
  rewriteLabel="重写后"
  pointerLabel="当前分支"
...
- [改写历史前备份](/zh/best-practices/backup-before-rewrite)
