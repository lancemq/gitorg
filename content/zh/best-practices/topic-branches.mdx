...
- 理解 主题分支策略 的核心作用和适用场景
- 掌握 主题分支策略 的基本用法和常用参数
- 用 topic branch 隔离单项工作，让并行开发、回滚、rebase、review 和发布边界都更清楚。
- 理解 为什么不要把所有工作都堆在一个长期分支上 相关的概念
- 掌握 1. 每项工作一个分支 相关的操作
...
<CommitGraphFigure
  title="主题分支工作流"
  caption="主题分支是为单一功能或任务创建的短生命周期分支。完成后合并到主线并删除，保持仓库整洁。"
  linearLabel="main 主线"
  mergeLabel="feature/auth 合并回主线"
  rewriteLabel="合并后删除分支"
  pointerLabel="分支生命周期"
/>
