...
- 理解 小步提交与主题分支整洁度 的核心作用和适用场景
- 掌握 小步提交与主题分支整洁度 的基本用法和常用参数
- 把提交粒度和主题分支边界同时管住，review 会更快，rebase 更稳，回滚也会轻松很多。
- 理解 为什么"提交小一点"不是形式主义 相关的概念
- 掌握 1. 一个提交只表达一个完整动作 相关的操作
...
<CommitGraphFigure
  title="聚焦提交与主题分支"
  caption="每个提交聚焦单一意图，每个主题分支聚焦单一功能。提交是微观的原子，分支是宏观的主题。"
  linearLabel="短生命周期分支 (< 2 天)"
  mergeLabel="定期 rebase 同步主线"
  rewriteLabel="提交前：git diff --staged 确认"
  pointerLabel="主题分支"
/>
