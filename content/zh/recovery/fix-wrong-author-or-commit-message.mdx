...
- 理解 提交后发现作者或信息写错怎么修正 的核心作用和适用场景
- 掌握 提交后发现作者或信息写错怎么修正 的基本用法和常用参数
...
<CommitGraphFigure
  title="替换错误提交的原理"
  caption="Git 的提交是不可变的。你不能编辑已有提交，但可以创建新提交来替代它。amend 替换最新提交，rebase -i 可以修改历史中间的提交。"
  linearLabel="原始提交链（含错误）"
  mergeLabel="amend 后（替换最新提交）"
  rewriteLabel="rebase -i 后（新提交链替代旧链）"
  pointerLabel="分支指向"
/>
